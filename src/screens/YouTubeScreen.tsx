...
export default function YouTubeScreen({ navigation }: Props) {
  ...
  const handleSaveAsStory = () => {
    ...
    const storyId = `youtube_${Date.now()}`;
    ...
    try {
      ...
      Alert.alert(
        'Save as Story',
        'Would you like to save this transcription as a story?',
        [
          {
            text: 'Cancel',
            style: 'cancel',
          },
          {
            ...
            onPress: () => {
              navigation.navigate('Story', {
                storyId: storyId,
                storyTitle: transcriptionResult.title,
      ...
      >
        ...
        {transcriptionResult && (
          <View style={styles.resultContainer}>
            ...
            <TouchableOpacity
              style={[styles.button, styles.saveStoryButton]}
              onPress={handleSaveAsStory}
              disabled={isLoading}
            >
              <Text style={styles.saveStoryButtonText}>Save as Story</Text>
            </TouchableOpacity>
          </View>
        )}
